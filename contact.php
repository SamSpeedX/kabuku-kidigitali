					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Contact</h1>
								<p class="mb-4">Hello. <br> welcome to Contact page. you have any problem you want to report or you want to suport this platform be free.</p>
              ...
              <div class="row mb-5">
                <div class="col-lg-4">
                  <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                    ...
                    <div class="service-contents">
                      <p>Kabuku, Handeni, Tanga, Tanzania.</p>
                ...
                <div class="col-lg-4">
                  <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                    ...
                    <div class="service-contents">
                      <p><a href="mailto:info@kabukukidigitali.com">info@kabukukidigitali.com</a></p>
                    </div> <!-- /.service-contents-->
                  </div> <!-- /.service -->
                </div>
                ...
                <div class="col-lg-4">
                  <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                    ...
                    <div class="service-contents">
                      <p><a href="tel:+255778760701">+255778760701</a></p>
                    </div> <!-- /.service-contents-->
                  </div> <!-- /.service -->
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="username"  value="<?php echo $jina; ?>" class="form-control" id="fname">
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="form-group">
                      <label class="text-black" for="lname">Last name</label>
                      <input type="text" name="ukoo" value="<?php echo $ukoo; ?>" class="form-control" id="lname">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <label class="text-black" for="email">Email address</label>
                  <input type="email" name="email" value="<?php echo $pepe; ?>" class="form-control" id="email">
                </div>
