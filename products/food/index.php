...
if (isset($_POST['add_to_cart'])) {
    ...
    if (mysqli_num_rows($ad_jb) > 0) {
        ...
        $inproduct = $kibalanga->prepare("INSERT INTO `cart`(user_id, name, price, image, quantity) VALUES(?, ?, ?, ?, ?)");
        $inproduct->bind_param('isisi', $uid, $product_name, $product_price, $product_image, $product_quantity);
        $inproduct->execute();
    ...
    <div class="container" id="furniture">
        ...
        <section class="products">
            ...
            <div class="box-container">
                ...
                <?php
                $fenichaas = 'hotel';
                $stmt = $kibalanga->prepare("SELECT * FROM `products` WHERE aina = ? ");
                $stmt->bind_param('s', $fenichaas);
                $stmt->execute();
                ...
                <div class="col-lg-8">
                    <div class="row links-wrap">
                        ...
                        <div class="col-6 col-sm-6 col-md-3">
                            <ul class="list-unstyled">
                                <!-- <li><a href="#">Jobs</a></li> -->
                                <li><a href="../../terms.html">Our team</a></li>
                ...
                <div class="row pt-4">
                    <div class="col-lg-6">
                        <p class="mb-2 text-center text-lg-start">Copyright &copy;<script>
                            ...
                            </script>. All Rights Reserved. &mdash; Developed by <a href="https://samtechnology.koyeb.app">Sam Technology</a>
                        </p>
                    </div>
