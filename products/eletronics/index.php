...
if (isset($_POST['add_to_cart'])) {
    ...
    if (mysqli_num_rows($ad_jb) > 0) {
        ...
        $inproduct = $kibalanga->prepare("INSERT INTO `cart`(name, price, image, quantity) VALUES(?, ?, ?, ?)");
        $inproduct->bind_param('sisi', $product_name, $product_price, $product_image, $product_quantity);
        $inproduct->execute();
